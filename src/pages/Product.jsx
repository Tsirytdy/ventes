...
const Wrapper = styled.div`
  padding: 50px;
  display: flex;
  ${mobileLandscape({ padding: "10px", flexDirection: "column" })}
`;
...
const Image = styled.img`
  ...
  height: 90vh;
  object-fit: cover;
  ${mobileLandscape({ height: "40vh" })}
`;

const InfoContainer = styled.div`
  flex: 1;
  padding: 0px 50px;
  ${mobileLandscape({ padding: "10px" })}
`;
